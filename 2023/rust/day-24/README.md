...
`~/Developer/advent-of-code/2023/rust/day-24`
...
Command | Description
--- | ---
`cargo new day-24` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-23 day-24` | Changes the current directory to the day-01 folder
