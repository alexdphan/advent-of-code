...
`~/Developer/advent-of-code/2023/rust/day-13`
...
Command | Description
--- | ---
`cargo new day-13` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-12 day-13` | Changes the current directory to the day-01 folder
