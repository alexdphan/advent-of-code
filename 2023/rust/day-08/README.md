...
`~/Developer/advent-of-code/2023/rust/day-08`
...
Command | Description
--- | ---
`cargo new day-08` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-07 day-08` | Changes the current directory to the day-01 folder
