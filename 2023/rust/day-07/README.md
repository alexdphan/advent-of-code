...
`~/Developer/advent-of-code/2023/rust/day-07`
...
Command | Description
--- | ---
`cargo new day-07` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-06 day-07` | Changes the current directory to the day-01 folder
