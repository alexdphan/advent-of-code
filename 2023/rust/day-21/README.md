...
`~/Developer/advent-of-code/2023/rust/day-21`
...
Command | Description
--- | ---
`cargo new day-21` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-20 day-21` | Changes the current directory to the day-01 folder
