...
`~/Developer/advent-of-code/2023/rust/day-18`
...
Command | Description
--- | ---
`cargo new day-18` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-17 day-18` | Changes the current directory to the day-01 folder
