...
`~/Developer/advent-of-code/2023/rust/day-16`
...
Command | Description
--- | ---
`cargo new day-16` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-15 day-16` | Changes the current directory to the day-01 folder
