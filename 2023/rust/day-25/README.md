...
`~/Developer/advent-of-code/2023/rust/day-25`
...
Command | Description
--- | ---
`cargo new day-25` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-24 day-25` | Changes the current directory to the day-01 folder
