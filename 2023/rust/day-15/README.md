...
`~/Developer/advent-of-code/2023/rust/day-15`
...
Command | Description
--- | ---
`cargo new day-15` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-14 day-15` | Changes the current directory to the day-01 folder
