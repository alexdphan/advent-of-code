...
`~/Developer/advent-of-code/2023/rust/day-06`
...
Command | Description
--- | ---
`cargo new day-06` | Creates a new Rust project called day-01 (or do the comman below)
`cp -day-05 day-06` | Changes the current directory to the day-01 folder
